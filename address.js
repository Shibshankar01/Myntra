...
document.querySelector("#state").addEventListener("change", stateFun);
function stateFun(event) {
   var StateSelected = document.querySelector("#state").value;
   var optionsList;
   var htmlString = "";
   ...
   document.querySelector("#city").innerHTML = htmlString;
}
